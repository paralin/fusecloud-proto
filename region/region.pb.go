...
type Region_RegionState struct {
	...
	ConsulBootstrapped  bool `protobuf:"varint,2,opt,name=consul_bootstrapped,json=consulBootstrapped,proto3" json:"consul_bootstrapped,omitempty"`
}
...
func (m *Region_RegionState) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsulBootstrapped", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorRegion = []byte{
	...
	,
}
